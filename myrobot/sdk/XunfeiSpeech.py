...
def synthesize(msg, voice_name="xiaoyan"):
    """
    科大讯飞TTS
    """
    ...
    with tempfile.NamedTemporaryFile() as f:
        gTTSPath = f.name
    ttsWsParam = TTS_Ws_Param(APPID='5d7e11a8', APIKey='96ff7d1e79f6f780aa1a14cc7ce54547',
                              APISecret='fefd2cecbef56f96ab87d4d2a0ff472c',
                              Text=msg,
